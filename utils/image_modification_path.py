...
def print_single_image_modification_path(best_softmax_list, num_classes, id_class_list, original_label, batch_index=0):
    ...
    for iteration_index, iteration in enumerate(best_softmax_list):
        ...
        for index in range(num_classes):
            class_prediction_string_concat += id_class_list[max_indices_list[index]].upper() + ": " + str(max_value_list[index])
    ...
    #print("The avg. score of", cifar10_labels[max_indices_list[0]].upper().upper(), "is", avg_score_of_final_detected_class)
